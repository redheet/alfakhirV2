        ...
        <div className="row">
          <div className="col-xl-7 col-lg-8">
            <div className="tf__banner_text wow fadeInUp">
              <h5>Welcome to AlFakhir!</h5>
              <h1>
                Where Learning <span>Becomes</span> Adventure!
              </h1>
              <p>
                AlFakhir is more than just a platform; it's a nurturing space
                where education transforms into an exciting adventure. With a
                passion for igniting curiosity and inspiring young minds.
              </p>
