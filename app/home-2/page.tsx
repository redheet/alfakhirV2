...
const page = async () => {
  ...
  return (
    <div className="home_2">
      ...
      {testimonialData && (
        <TestimonialSection2 testimonialData={testimonialData} />
      )}
      {courseData && (
        <CourseSection style="tf__courses_2" courseData={courseData} />
      )}
      {teamData && (
        <TeamSection
          style="tf__team_2 mt_100 pt_95 pb_100"
          teamData={teamData}
        />
      )}
